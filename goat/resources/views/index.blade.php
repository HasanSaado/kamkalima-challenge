...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="slide-one-item home-slider owl-carousel">
      <div class="site-blocks-cover overlay" style="background-image: url(app-assets/images/hero_bg_2.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(app-assets/images/hero_bg_4.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-start">
            <div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400">
              <h1 class="bg-text-line">Russia's World Cup Championship</h1>
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(app-assets/images/hero_bg_3.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-start">
            <div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400">
              <h1 class="bg-text-line">Russia's World Cup Championship</h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <div class="p-3 p-md-5 feature-block-1 mb-5 mb-lg-0 bg" style="background-image: url('app-assets/images/img_1.jpg');">
              <div class="text">
          ...
          <div class="col-md-6 col-lg-4">
            <div class="p-3 p-md-5 feature-block-1 mb-5 mb-lg-0 bg" style="background-image: url('app-assets/images/img_2.jpg');">
              <div class="text">
                <h2 class="h5 text-white">Russia's World Cup Championship</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos repellat autem illum nostrum sit distinctio!</p>
              </div>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="p-3 p-md-5 feature-block-1 mb-5 mb-lg-0 bg" style="background-image: url('app-assets/images/img_3.jpg');">
              <div class="text">
                <h2 class="h5 text-white">Russia's World Cup Championship</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos repellat autem illum nostrum sit distinctio!</p>
              </div>
    ...
    <div class="site-blocks-vs site-section bg-light">
      <div class="container">
          ...
          <div class="ml-auto pr-4 order-md-2">
            <div class="h5 text-black text-uppercase text-center text-lg-left">
              <div class="d-block d-md-inline-block mb-3 mb-lg-0">
                <img src="{{URL::to('/')}}/app-assets/images/img_1_sq.jpg" alt="Image" class="mr-3 image"><span class="d-block d-md-inline-block ml-0 ml-md-3 ml-lg-0">Sea Hawlks </span>
              </div>
              <span class="text-muted mx-3 text-normal mb-3 mb-lg-0 d-block d-md-inline ">vs</span>
              <div class="d-block d-md-inline-block">
                <img src="{{URL::to('/')}}/app-assets/images/img_3_sq.jpg" alt="Image" class="mr-3 image"><span class="d-block d-md-inline-block ml-0 ml-md-3 ml-lg-0">Patriots</span>
              </div>
              <div class="d-block d-md-inline-block">
                <img src="{{URL::to('/')}}/app-assets/images/img_3_sq.jpg" alt="Image" class="mr-3 image"><span class="d-block d-md-inline-block ml-0 ml-md-3 ml-lg-0">Patriots</span>
              </div>
        ...
        <div class="bg-image overlay-success rounded mb-5" style="background-image: url('app-assets/images/hero_bg_1.jpg');" data-stellar-background-ratio="0.5">
              ...
              <div class="text-center text-lg-left">
                <div class="d-block d-lg-flex align-items-center">
                  <div class="image mx-auto mb-3 mb-lg-0 mr-lg-3">
                    <img src="{{URL::to('/')}}/app-assets/images/img_1_sq.jpg" alt="Image" class="img-fluid">
                  </div>
                  <div class="text">
              ...
              <div class="">
                <div class="d-block d-lg-flex align-items-center">
                  <div class="image mx-auto ml-lg-3 mb-3 mb-lg-0 order-2">
                    <img src="{{URL::to('/')}}/app-assets/images/img_4_sq.jpg" alt="Image" class="img-fluid">
                  </div>
    ...
    <div class="site-section block-13 bg-primary fixed overlay-primary bg-image" style="background-image: url('app-assets/images/hero_bg_3.jpg');" data-stellar-background-ratio="0.5">
        ...
        <div class="row">
          <div class="nonloop-block-13 owl-carousel">
            <div class="item">
              ...
              <div class="block-12">
                <figure>
                  <img src="{{URL::to('/')}}/app-assets/images/img_1.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="text">
            ...
            <div class="item">
              <div class="block-12">
                <figure>
                  <img src="{{URL::to('/')}}/app-assets/images/img_2.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="text">
                  <span class="meta">May 20th 2018</span>
                  <div class="text-inner">
            ...
            <div class="item">
              <div class="block-12">
                <figure>
                  <img src="{{URL::to('/')}}/app-assets/images/img_3.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="text">
                  <span class="meta">May 20th 2018</span>
                  <div class="text-inner">
            ...
            <div class="item">
              <div class="block-12">
                <figure>
                  <img src="{{URL::to('/')}}/app-assets/images/img_4.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="text">
                  <span class="meta">May 20th 2018</span>
                  <div class="text-inner">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4">
            <div class="post-entry">
              <div class="image">
                <img src="app-assets/images/img_2.jpg" alt="Image" class="img-fluid">
              </div>
              <div class="text p-4">
                <h2 class="h5 text-black"><a href="#">RealMad vs Striker Who Will Win?</a></h2>
                <span class="text-uppercase date d-block mb-3"><small>By Colorlib &bullet; Sep 25, 2018</small></span>
        ...
        <div class="row">
                  ...
                  <li class="mb-3">
                    <a href="#" class="d-flex">
                      <figure class="image mr-4">
                        <img src="{{URL::to('/')}}/app-assets/images/img_1.jpg" alt="" class="img-fluid">
                      </figure>
                      <div class="text">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            <div class="mb-5">
              ...
              <div class="block-16">
                <figure>
                  <img src="{{URL::to('/')}}/app-assets/images/img_1.jpg" alt="Image placeholder" class="img-fluid rounded">
